...
using AuthorityKeyIdentifier = CertLedgerBusinessSCTemplate.src.io.certledger.AuthorityKeyIdentifier;
using BasicConstraints = CertLedgerBusinessSCTemplate.src.io.certledger.BasicConstraints;
using ExtendedKeyUsage = CertLedgerBusinessSCTemplate.src.io.certledger.ExtendedKeyUsage;
using KeyUsage = CertLedgerBusinessSCTemplate.src.io.certledger.KeyUsage;
using SubjectKeyIdentifier = CertLedgerBusinessSCTemplate.src.io.certledger.SubjectKeyIdentifier;
...
namespace io.certledger.smartcontract.platform.netcore
{
    public class NetCoreCertificateParser
    {
        ...
        public static BasicConstraints retrieveBasicContraints(X509Certificate2 x509Certificate)
        {
            ...
            if (x509CertificateExtension != null)
            {
                X509BasicConstraintsExtension basicConstraintsExtension =
                    (X509BasicConstraintsExtension) x509CertificateExtension;
        ...
        public static AuthorityKeyIdentifier retrieveAuthorityKeyIdentifier(X509Certificate x509Certificate)
        {
            ...
            X509Extension x509Extension =
                x509Certificate.CertificateStructure.TbsCertificate.Extensions.GetExtension(
                    new DerObjectIdentifier(OIDS.OID_AUTHORITY_KEY_IDENTIFIER_EXTENSION));
            if (x509Extension != null)
            {
                Org.BouncyCastle.Asn1.X509.AuthorityKeyIdentifier authorityKeyIdentifierExtension =
                    Org.BouncyCastle.Asn1.X509.AuthorityKeyIdentifier.GetInstance(x509Extension);
        ...
        public static ExtendedKeyUsage retrieveExtendedKeyUsageOIDs(X509Certificate x509Certificate)
        {
            ...
            X509Extension x509Extension =
                x509Certificate.CertificateStructure.TbsCertificate.Extensions.GetExtension(
                    new DerObjectIdentifier(OIDS.OID_EXTENDED_KEY_USAGE_EXTENSION));
            if (x509Extension != null)
            {
                Org.BouncyCastle.Asn1.X509.ExtendedKeyUsage extendedKeyUsageExtension =
                    Org.BouncyCastle.Asn1.X509.ExtendedKeyUsage.GetInstance(x509Extension);
